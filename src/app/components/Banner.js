        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="w-4/5 items-center m-auto p-2 px-4 rounded-b-2xl md:flex justify-between bg-[#303030]">
            ...
            <div className="flex justify-center space-x-4">
              <Image src="/icon/windows.svg" alt="Windows" width={20} height={20} />
              <Image src="/icon/apple.svg" alt="Apple" width={20} height={20} />
              <Image src="/icon/android.svg" alt="Android" width={20} height={20} />
              <Image src="/icon/linux.svg" alt="Linux" width={20} height={20} />
              <Image src="/icon/chrome.svg" alt="Chrome" width={20} height={20} />
            </div>
          </div>
        </div>
      </div>
